...
# Now reexecute the dialog and then select "Get Enterprise Context Variable value"
 ...
 # Select "Set User Session Variable value"
    ...
    * def Payload =
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.text == ["Message tone sad identified"]
    ...
    * def Payload =
    ...
    And match $.text == ["This task failure event message rendered from environment variables"]
     ...
     Scenario: This test is to verify KG Mandatory node functionality
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
        {
        "message": {
            "text": "Mandatory Node Validation FAQ"
        },
        "from": {
            "id": "kore123"
        },
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.text == ["Mandatory Node Validation FAQ triggered successfully"]
    
    #Input Node Validation FAQ
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.completedTaskName == "fallback task"
   
     Scenario: This test is to verify KG Default node functionality
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
    ...
    Then status 200
    And print 'Response is: ', response
    And match $..text == ["{\"text\":\"Did you mean?\\na) How do I open savings bank account?\\n\",\"isTemplate\":true}"]
    
    
    Scenario: This test is to verify the Organizer node functionality
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
        {
        "message": {
            "text": "Organizer Node validation faq"
        },
        "from": {
            "id": "kore123"
        },
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.text == ["Organizer Node working as expected"]
    ...
    * print ConsumerWebHookJWT
    ...
    And print 'Response is: ', response
     ...
     Scenario: Case1 This test is to verify the functionality of Setting Contextual Output and the Intent Precondition check in KG
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
        {
        "message": {
            "text": "KG ContextualOutput setting FAQ"
        },
        "from": {
            "id": "kore123"
        },
    ...
    Then status 200
    And print 'Response is: ', response
     And match $.text == ["KG ContextualOutput Setting FAQ executed successfully"]
   
   
 
    Scenario: Case2 This test is to verify the functionality of Setting Contextual Output and the Intent Precondition check in KG
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
        {
        "message": {
            "text": "Intent precondition validation FAQ"
        },
        "from": {
            "id": "kore123"
        },
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.text == ["Intent Precondition validation FAQ triggered successfully"]
    
    
    
     Scenario: Case3 This test is to verify the functionality of Setting Contextual Output and the Intent Precondition check in KG
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
    ...
    Scenario: This test is to verify the functionality of Term status when it is toggle is enabled
    * def ConsumerWebHookJWT = JavaClass.get('ConsumerWebHookJWT')
    * print ConsumerWebHookJWT
    * def Payload =
      """
        {
        "message": {
            "text": "EnableNode FAQ Validation"
        },
        "from": {
            "id": "kore123"
        },
    ...
    And match $.text == ["Term Status enabling working as expected."]
    ...
    * def Payload =
      """
        {
        "message": {
            "text": "DisableNode FAQ Validation"
        },
        "from": {
            "id": "kore123"
        },
    ...
    * def Payload =
      """
        {
        "message": {
            "text": "DynamicContentVariableRendering"
        },
        "from": {
            "id": "kore123"
        },
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.text == ["Dynamic Content variable rendered successfully"]
