...
Feature: validating summary Details
 ...
 Scenario: Getting StreamID
    Given path '/users/'+botadminUserID1+'/builder/streams'
    ...
    * def streamId = response.find(x => x.name == name)._id
    * print streamId
   ...
   * def streamId = JavaClass.get('streamId')
    Given path '/stream/'+streamId+'/testsuitesummary'
    And header Authorization = 'bearer '+botadminaccesstokenuser1
    And header Content-Type = 'application/json'
    ...
    * print smallTalkTotal
    And string convert_num_to_string11 = smallTalkTotal
    And string convert_num_to_string22 = smallTalkTPCount
    And string convert_num_to_string33 = smallTalkFPCount
    And string convert_num_to_string44 = smallTalkTestcasesCount
    And string convert_num_to_string55 = smallTalkTestcasesCoveredCount
    * def smallTalkFPCount = convert_num_to_string33
    * def smallTalkTotal = convert_num_to_string11
    * def smallTalkTPCount = convert_num_to_string22
    * def smallTalkTestcasesCount = convert_num_to_string44
    * def smallTalkTestcasesCoveredCount = convert_num_to_string55
