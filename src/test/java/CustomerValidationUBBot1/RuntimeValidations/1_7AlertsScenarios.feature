...
Feature: Interacting with the bot using webhook channel
  ...
  Scenario: input discard
    ...
    * print ConsumerWebHookJWT
    ...
    Then status 200
    And print 'Response is: ', response
    And match $.text ==  ["Webhook alert subscription via smart alert successfulHere is the webhook url generated : &quot;https://staging-bots.korebots.com/hooks/243a205eaaef4ee0f1d503998e0e1377&quot;"]
