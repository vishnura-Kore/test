...
Feature: Login Into AnotherAccount
  ...
  Scenario: Generate AuthToken
    ...
    When request { "password":'Kore@112233', "client_id":"1", "client_secret":"1","scope":"friends","grant_type":"password","username":'zudij@getairmail.com' }
    And method post
    Then status 200
  ...
  Scenario: create appscope
    ...
    * print Payload
    ...
    And header accountid = '5e832afa52575f5e63608434'
    When method post
    Then status 200
    And print 'Response is: ', response
  ...
  Scenario: Assiging appscopes
    ...
    * print botadminorgID2
    * print scopeclientId12
    * def Payload = read('JSONUploadFiles/AssginingAppScopes.json')
   ...
   * def JavaClass = Java.type('data.HashMap')
    ...
    * print name
    * def Payload = read('JSONUploadFiles/CreateBot2.json')
